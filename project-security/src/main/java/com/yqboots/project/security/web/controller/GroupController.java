...
public class GroupController {
    private static final String REDIRECT_VIEW_PATH = "redirect:/project/security/group";
    private static final String VIEW_HOME = "project/security/group/index";
    private static final String VIEW_FORM = "project/security/group/form";
