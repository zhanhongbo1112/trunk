...
public class UserGroupsHtmlOptionsResolver extends AbstractHtmlOptionsResolver {
    /**
    ...
    /**
     * Constructs {@link UserGroupsHtmlOptionsResolver}.
     *
     * @param userManager userManager
     */
    @Autowired
    public UserGroupsHtmlOptionsResolver(final UserManager userManager) {
        super(NAME_KEY);
