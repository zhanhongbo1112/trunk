 ...
 *
 */
package com.yqboots.project.security.core.audit.interceptor;

import com.yqboots.project.security.core.audit.AuditProvider;
...
public class AuditInterceptor implements MethodInterceptor, Serializable {
    /**
     * List of {@link AuditProvider}, defaults to empty.
     */
