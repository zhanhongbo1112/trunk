...
public class RoleManagerTest {
    ...
    public void testUpdateUsersByUserIds() throws Exception {
        ...
        Long[] inUsers = new Long[]{2L}; // USER_ID = 2
        roleManager.updateUsers("/ADMINS", inUsers);
    ...
    @Test
    public void testUpdateGroupsByGroupIds() throws Exception {
        int count = JdbcTestUtils.countRowsInTableWhere(jdbcTemplate, "SEC_GROUP_ROLES", "GROUP_ID=2 and ROLE_ID=1");
        assertTrue(count == 0);
        count = JdbcTestUtils.countRowsInTableWhere(jdbcTemplate, "SEC_GROUP_ROLES", "GROUP_ID=1 and ROLE_ID=1");
        assertTrue(count == 1);

        Long[] inGroups = new Long[]{2L}; // GROUP_ID = 2
        roleManager.updateGroups("/ADMINS", inGroups);
    ...
    public void testRemoveUsersByUserIds() throws Exception {
        ...
        roleManager.removeUsers("/USERS", 2L);
    ...
    @Test
    public void testRemoveGroupsByGroupIds() throws Exception {
        int count = JdbcTestUtils.countRowsInTableWhere(jdbcTemplate, "SEC_GROUP_ROLES", "GROUP_ID=1 AND ROLE_ID=1");
        assertTrue(count == 1);

        roleManager.removeGroups("/ADMINS", 1L);
