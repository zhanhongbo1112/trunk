...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '添加新用户', '1', 'CODE_ADD_USER');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', 'UPDATE USER', '2', 'CODE_UPDATE_USER');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '更新用户', '2', 'CODE_UPDATE_USER');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '更新用户组', '20', 'CODE_UPDATE_GROUPS_OF_USER');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '更新用户角色', '21', 'CODE_UPDATE_ROLES_OF_USER');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', 'REMOVE USER', '3', 'CODE_REMOVE_USER');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '移除用户', '3', 'CODE_REMOVE_USER');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '从用户移除组', '30', 'CODE_REMOVE_GROUPS_FROM_USER');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '从用户移除角色', '31', 'CODE_REMOVE_ROLES_FROM_USER');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', 'ADD GROUP', '4', 'CODE_ADD_GROUP');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '添加用户组', '4', 'CODE_ADD_GROUP');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', 'UPDATE GROUP', '5', 'CODE_UPDATE_GROUP');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '更新用户组', '5', 'CODE_UPDATE_GROUP');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '更新用户组中的用户', '50', 'CODE_UPDATE_USERS_OF_GROUP');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '更新用户组中的角色', '51', 'CODE_UPDATE_ROLES_OF_GROUP');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', 'REMOVE GROUP', '6', 'CODE_REMOVE_GROUP');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '移除用户组', '6', 'CODE_REMOVE_GROUP');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '移除用户组中的用户', '60', 'CODE_REMOVE_USERS_FROM_GROUP');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '移除用户组中的角色', '61', 'CODE_REMOVE_ROLES_FROM_GROUP');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', 'ADD ROLE', '7', 'CODE_ADD_ROLE');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '添加角色', '7', 'CODE_ADD_ROLE');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', 'UPDATE ROLE', '8', 'CODE_UPDATE_ROLE');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '更新角色', '8', 'CODE_UPDATE_ROLE');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '更新角色关联的用户', '80', 'CODE_UPDATE_USERS_OF_ROLE');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '更新角色关联的用户组', '81', 'CODE_UPDATE_GROUPS_OF_ROLE');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', 'REMOVE ROLE', '9', 'CODE_REMOVE_ROLE');
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '移除角色', '9', 'CODE_REMOVE_ROLE');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '移除角色关联的用户', '90', 'CODE_REMOVE_USERS_FROM_ROLE');
...
insert into PRJ_DATA_DICT (name, text, value, description) values ('SECURITY_AUDIT_CODES', '移除角色关联的用户组', '91', 'CODE_REMOVE_GROUPS_FROM_ROLE');
