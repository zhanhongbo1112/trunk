...
public class SecurityAudit extends Audit {
    ...
    public static final int CODE_ADD_USER_WITH_GROUPS_AND_ROLES = 12;
    ...
    public static final int CODE_UPDATE_USER_WITH_GROUPS_AND_ROLES = 22;
    ...
    public static final int CODE_ADD_GROUP_WITH_USERS_AND_ROLES = 42;
    ...
    public static final int CODE_UPDATE_GROUP_WITH_USERS_AND_ROLES = 52;
    ...
    public static final int CODE_ADD_ROLE_WITH_USERS_AND_GROUPS = 72;
    ...
    public static final int CODE_UPDATE_ROLE_WITH_USERS_AND_GROUPS = 82;
